...
export default function LoginPage() {
  ...
  const handleSignIn = async (provider: Provider) => {
    ...
    if (result?.error) {
      setError('Authentication failed. Check your Google/GitHub OAuth credentials and callback URLs.');
    }
  ...
  return (
    <main>
      <div className="card">
        ...
        {error ? (
          <p className="error-message" style={{ color: 'crimson', marginBottom: '1rem' }}>
            {error}
          </p>
        ) : null}
